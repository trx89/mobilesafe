...
import com.trx.mobilesafe.dao.VirusDao;
...
public class VirusActivity extends Activity {
	...
	// 病毒集合
	private ArrayList<ScanInfo> mVirusList = new ArrayList<VirusActivity.ScanInfo>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivScanning = (ImageView) findViewById(R.id.iv_scan);
		tvStatus = (TextView) findViewById(R.id.tv_scan);
		pbProgress = (ProgressBar) findViewById(R.id.pb_load);
