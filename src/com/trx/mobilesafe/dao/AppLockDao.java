...
import com.trx.mobilesafe.db.AppLockOpenHelper;
...
public class AppLockDao {
	...
	public void add(String packageName) {
		...
		// 通知数据库发生变化
		LogUtils.d(this, "add applock");
		mContext.getContentResolver().notifyChange(
				Uri.parse("content://com.trx.mobilesafe/applock"), null);
	}
	...
	public void delete(String packageName) {
		...
		// 通知数据库发生变化
		LogUtils.d(this, "delete applock");
		mContext.getContentResolver().notifyChange(
				Uri.parse("content://com.trx.mobilesafe/applock"), null);
	}
